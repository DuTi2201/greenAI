...
export const generateWeeklyReportTemplate = (data: any) => {
    ...
    <body>
      <div class="container">
        <div class="header">
          ...
          <p>${format(data.startDate, 'dd/MM/yyyy', { locale: vi })} - ${format(data.endDate, 'dd/MM/yyyy', { locale: vi })}</p>
        </div>
        ...
        <div class="section">
          ...
          <div class="card">
            <ul class="device-list">
              ${data.energyUsage.byDevice.map((device: any) => `
        ...
        <div class="section">
          ...
          <div class="card">
            <ul class="device-list">
              ${data.waterUsage.byPump.map((pump: any) => `
                <li class="device-item">
        ...
        <div class="section">
          ...
          <div class="card">
            <ul class="device-list">
              ${data.sensorStats.map((sensor: any) => `
                <li class="device-item">

...
exports.WemosValidator = void 0;
const logger_1 = require("../utils/logger");
class WemosValidator {
    // Kiểm tra dữ liệu cảm biến
    static validateSensorData(req, res, next) {
        const data = req.body;
        const errors = [];
        ...
        if (errors.length > 0) {
            logger_1.logger.error('Validation errors:', errors);
    ...
    static validateConfig(req, res, next) {
...
exports.WemosValidator = WemosValidator;
